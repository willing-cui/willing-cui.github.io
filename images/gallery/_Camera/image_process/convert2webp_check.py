...
def main():
    ...
    #    如果输入是文件，输出是文件路径
    #    如果输入是目录，输出是目录路径
    output_path = r"D:/GitHub/willing-cui.github.io/images/gallery/check"  # 修改为你的输出路径，设为 None 则自动生成

    # 3. 图片处理参数
    scale_factor = 1.0  # 缩小倍数
    quality = 95  # WebP压缩质量 (1-100)，85是较好的平衡点
